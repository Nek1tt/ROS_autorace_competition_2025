...
class ArucoOneShotNode(Node):
    def __init__(self):
        ...
        # НОВЫЙ ПАРАМЕТР: Минимальная площадь маркера (в пикселях).
        # Чем БОЛЬШЕ число, тем БЛИЖЕ должен быть робот, чтобы сработало.
        # Начни с 3000. Если срабатывает слишком далеко -> ставь 5000 или 10000.
